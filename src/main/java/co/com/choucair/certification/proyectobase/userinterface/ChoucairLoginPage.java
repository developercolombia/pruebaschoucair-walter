...
public class ChoucairLoginPage {
    ...
    public static final Target  LOGIN_BUTTON = Target.the("button that shows us the form to login ").located(By.xpath("//div[@class='d-lg-block']//strong[contains(text(),'Ingresar')]"));

...
public class ChoucairAcademyStepDefintions {
    ...
    public void heSearchForTheCourseResourcesautomationBancolombiaOnTheChoucairAcademyPlatform(List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorInTheSpotlight().attemptsTo(Search.the(academyChoucairData.get(0).getStrCourse()));

    }

    @Then("^he finds the course called resources (.*)$")
    public void heFindsTheCourseCalledResourcesResourcesautomationBancolombia(List<AcademyChoucairData> academyChoucairData) throws Exception {
